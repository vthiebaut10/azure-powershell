...
namespace Microsoft.Azure.Commands.Ssh
{
    public abstract class SshBaseCmdlet : AzureRMCmdlet
    {
        ...
        private Track2HybridConnectivityManagementClient _track2HybridConnectivityManagementClient;
        public Track2HybridConnectivityManagementClient Track2ConnectivityManagementClient
        {
            get
            {
                return _track2HybridConnectivityManagementClient ?? (_track2HybridConnectivityManagementClient = new Track2HybridConnectivityManagementClient(AzureSession.Instance.ClientFactory, DefaultContext));
            }

            set { _track2HybridConnectivityManagementClient = value; }
        }
